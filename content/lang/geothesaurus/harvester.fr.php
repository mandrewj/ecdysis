...
$LANG['SHOW_NO_DATABASE'] = 'Afficher les limites manquantes dans la base de données';
$LANG['COUNTRY'] = 'Pays';
$LANG['COUNTY'] = 'Comté';
...
$LANG['INSTALL_VIA_SCRIPT'] = 'Le <a href="https://symbiota.org" target="_blank">Centre d\'assistance Symbiota</a> a fourni un script de données permettant de créer un thésaurus géographique de base.
	Ce fichier de données contient les noms de lieux de tous les pays, les États/provinces du Canada, des États-Unis et du Mexique, ainsi que les comtés/paroisses des États-Unis et du Canada.
...
$LANG['TABLE_DATABASE_COUNT'] = 'Nombre de bases de données';
$LANG['TABLE_ISO3'] = 'ISO3';
$LANG['TABLE_DATABASE'] = 'Base de données';
$LANG['TABLE_POLYGON'] = 'Polygone';
$LANG['TABLE_BOUNDARY_ID'] = 'ID de limite';
$LANG['TABLE_CANONICAL_NAME'] = 'Nom canonique';
$LANG['TABLE_LICENSE'] = 'Licence';
$LANG['TABLE_REGION'] = 'Région';
$LANG['TABLE_FULL_LINK'] = 'Lien complet';
$LANG['TABLE_IMAGE_PREVIEW'] = 'Aperçu de l\'image';
$LANG['OUI'] = 'Oui';
$LANG['NON'] = 'Non';
